# No-fallback first checkpoint — Code
...
- Your final message must be the COMPLETE report in the mandated format, and
  nothing else. It will be filed verbatim as dev-docs/GwzNoFallbackCheckpoint-ReviewCode.md — write it as a
