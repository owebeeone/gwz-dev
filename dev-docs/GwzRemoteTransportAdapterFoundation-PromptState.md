...
- Your final message must be the COMPLETE report in the mandated format, and
  nothing else. It will be filed verbatim as dev-docs/GwzRemoteTransportAdapterFoundation-ReviewState.md — write it as a
...
REVIEW AREAS
Attack lost/spurious/synchronous wakes, blocking future/drop/cancellation, prefix/EOF/error distinctions, no retry of effects, half-close/cleanup, bounded regression tests, no deadlocking sole dispatcher, packaging failure side effects/source integrity and locked graph.
COMMANDS
...
- python3 gwz-core/tests/transport_native/distribution/fork.py --git2-archive /Users/owebeeone/.cargo/registry/cache/index.crates.io-1949cf8c6b5b557f/git2-0.21.0.crate --output /tmp/gwz-git2-review-state-20260920 (use fresh output if occupied)
