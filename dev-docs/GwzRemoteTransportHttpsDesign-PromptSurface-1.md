...
- Your final message must be the COMPLETE report in the mandated format, and
  nothing else. It will be filed verbatim as dev-docs/GwzRemoteTransportHttpsDesign-ReviewSurface-1.md — write it as a
...
REVIEW AREAS
Read only user-facing gwz-core/docs/TransportPlacement.md and unchanged related embedding guides. Review refined HTTPS reused/credential_offered/authenticated meaning against SSH explanation; no new CLI/public constructor is claimed. Do not read implementation or design beyond this documentation-only surface. Lifecycle/API are unchanged; no implementation walkthrough is claimed.
