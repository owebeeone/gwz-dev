# N3 remediation1 — retained State closure review

Continue under the canonical role, evidence/severity and read-only instructions
in GwzRemoteTransportSshN3-PromptState.md. The exact replacement tuple is:
...
Return complete report verbatim as GwzRemoteTransportSshN3-ReviewState-1.md;
