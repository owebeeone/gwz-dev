...
- Your final message must be the COMPLETE report in the mandated format, and
  nothing else. It will be filed verbatim as dev-docs/GwzRemoteTransportPlacementB-ReviewCode-1.md — write it as a
...
REVIEW AREAS
Scoped backend metadata binding and all N3 network funnel call graphs; no CLI/core physical carrier or production activation. Review src/transport_host, git/endpoint/placement_endpoint.rs and ssh_worker/pump changes; exact guide fixture, opaque endpoint identities, error/facts mapping, queue/time limits and source generation. Check integration claims against tests.
