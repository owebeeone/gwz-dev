...
- Your final message must be the COMPLETE report in the mandated format, and
  nothing else. It will be filed verbatim as dev-docs/GwzRemoteTransportHttpsH1-ReviewState.md — write it as a
...
REVIEW AREAS
Attack helper and native-job lifetime, physical capacity/reservation disposal, TLS/proxy/auth isolation, cancellation/early response/backpressure/timers, error/effect/facts honesty, retries and route races. Examine https_auth/connection/progress/pool/worker/local, shared_reservation, fixtures and failure logs. Check whether logical timeout/close is incorrectly treated as actual disposal.
