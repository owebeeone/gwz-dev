...
- Your final message must be the COMPLETE report in the mandated format, and
  nothing else. It will be filed verbatim as dev-docs/GwzRemoteTransportNativeBinding-ReviewSurface.md — write it as a
...
REVIEW AREAS
Read ONLY gwz-core/tests/transport_native/README.md and prove.py --help. No implementation, plan or design reading. Walk documented first-day setup/use/cleanup and assess proposed API ownership, default/mode, errors and retained-remote contract.
COMMANDS
