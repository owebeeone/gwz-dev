...
- Your final message must be the COMPLETE report in the mandated format, and
  nothing else. It will be filed verbatim as dev-docs/GwzRemoteTransportSshChannel-ReviewSurface-1.md — write it as a
...
REVIEW AREAS
Read ONLY gwz-core/tests/transport_ssh/README.md and public command outputs. Cold-walk the API contract and native fixture from this README; check readiness/error/EOF, finish/extract and abort/drop lifecycle, documented prerequisites, ownership, defaults and limits. Do not read implementation, tests, internal plan/design or peer reports.
COMMANDS
