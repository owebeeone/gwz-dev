...
- Your final message must be the COMPLETE report in the mandated format, and
  nothing else. It will be filed verbatim as dev-docs/GwzGitLibraryNextPackages-ReviewState.md — write it as a
...
- root: 74fa1855fcc5ae336ba9edc4541e164b5c6fc45a 
- gwz-core: 5b05768c98f246a4f7ac8c00d5961ba19ebc5310
- gwz-git: aa77c2ce5ad0bf6b4f4b64b2d8fd75e8547c3b4c
- git2-rs: ce78628308e11b4e8901d5061602619109bce21a
- libgit2: b172e3d187a4b6866fd9f696f40a1b8e7f56d348
- Object: gwz-core/dev-docs/GwzGitLibraryNextPackages.md: scope only before any C1/H1 implementation; current routes are read-only evidence for feasibility.
- Controlling DRAFT document: gwz-core/dev-docs/GwzGitLibraryNextPackages.md at 5b05768c98f246a4f7ac8c00d5961ba19ebc5310
...
COMMANDS
From workspace: git rev-parse HEAD; git -C <member> rev-parse HEAD; git show <SHA>:<path>; gwz status; read-only rg/sed/cat/nl. No builds or new experiments in this scope review. Verify tuple start/end. Return concise complete report, findings only concrete blockers/defects, no fresh whole-world review.
